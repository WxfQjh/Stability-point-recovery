...
from dataset import ShapenetComplete
...
parser.add_argument('--save_path',default='./GFV_T_C', help='Path to Data Set')
...
def main(args):
     ...
     train_dataset = ShapenetComplete('data/PCN', 'train', args.category)
