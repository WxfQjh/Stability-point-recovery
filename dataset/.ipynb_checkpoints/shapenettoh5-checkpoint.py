...
class ShapeNettoH5py(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(partial_pc), torch.from_numpy(complete_pc), partial_path, complete_path
...
if __name__ == '__main__':
    train_dataset = ShapeNet('/home/qjh/PCN-PyTorch/data/PCN', 'test', 'all')